...
## How to use
To implement a routing algorithm, create a new implementation in `node_impl` (see `node_impl/naive.h` for example). Add appropriate statements at places marked `XXX` in `src/simulation.cc` to use it in the simulator.
